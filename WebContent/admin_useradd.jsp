...
<jsp:include page="admin_top.jsp" ></jsp:include>
					<div id="content_right">
						...
						<br />
						<form name="empForm" method="post" action="admin_useradd" onsubmit="return add();">
							<table cellpadding="0" cellspacing="1" border="0"
								...
								<tr>
									...
									<td>
										<input type="text" name="username" value="" onblur="check();"
											class="inputgri">
										&nbsp;
								...
								<tr>
									...
									<td>
										<input type="text" name="name" value="" class="inputgri">
										&nbsp;
										<font color="red" size="2">*</font>
									</td>
									<td id="d1"></td>
								...
								<tr>
									...
									<td>
										<input type="text" name="job" value="" class="inputgri">
										&nbsp;
										<font color="red" size="2">*</font>
									</td>
									<td id="d4"></td>
								...
								<tr>
									...
									<td>
										<input type="text" name="entrytime" value="" class="inputgri">
										&nbsp;
										<font color="red" size="2">*</font>
									</td>
									<td id="d5"></td>
