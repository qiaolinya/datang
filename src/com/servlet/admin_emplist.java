...
/**
 * Servlet implementation class admin_emplist
 */
@WebServlet("/admin_emplist")
public class admin_emplist extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Employee> list=dao.getList(index,pagesize);
